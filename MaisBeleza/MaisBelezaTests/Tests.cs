    ...
    public class Tests
    {
        ...
        public static void ClassInitialize(TestContext context) //Inicializa um banco de dados em memória para ser usado durante os testes
        {
            ...
            using (var dbContext = new AppDbContext(_dbContextOptions))
            {
                ...
                {
                    new Mei { Id = 10, NomeMei = "Mei 1", Email = "mei1@gmail.com", Telefone = "3199999-9999", Rua = "A", Numero = "10a", Bairro = "B", Cidade = "BH", Estado = "MG", Perfil = Perfil.Administrador, Password = "abc123", HorarioFuncionamento = "8h às 12h" },
                    new Mei { Id = 12, NomeMei = "Mei 2", Email = "mei2@gmail.com", Telefone = "3198888-8888", Rua = "C", Numero = "20a", Bairro = "D", Cidade = "RJ", Estado = "RJ", Perfil = Perfil.Administrador, Password = "abc123", HorarioFuncionamento = "8h às 18h" },
                };
